...
public interface EstadoDAO extends JpaRepository<Estado, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.cidade FROM Cliente entity WHERE entity.estado.id = :id")
  public Page<Cidade> listCidade_2(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM Cliente entity WHERE entity.estado.id = :instanceId AND entity.cidade.id = :relationId")
  public int deleteCidade_2(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
